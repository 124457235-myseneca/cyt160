...
default_args = {
 ...
 'solutionname': 'kasun-tml-project1-b4b4',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_kasun-tml-project1-b4b4", default_args=default_args, tags=["tml_system_step_1_getparams_dag_kasun-tml-project1-b4b4"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
